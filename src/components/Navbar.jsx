...
import ADESLogo from "./ADESLogo";
import { useNavigate } from "react-router-dom";

const Navbar = () => {
  const navigate = useNavigate();
  const userName = "Ades Admin";
            ...
            <div className="px-1 py-1">
              <Menu.Item>
                {({ active }) => (
                  ...
                  >
                    <Cog6ToothIcon className="h-5 w-5 mr-2 text-gray-500 group-hover:text-white" />{" "}
                    {/* Icône pour Profil */}
                    Profil
                  </button>
                )}
              ...
              <Menu.Item>
                {({ active }) => (
                  ...
                  >
                    <ArrowRightEndOnRectangleIcon className="h-5 w-5 mr-2 text-gray-500 group-hover:text-white" />{" "}
